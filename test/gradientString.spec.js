...
describe('GradientString', () => {
  describe('matchString()', () => {
    it('should match gradient string', () => {
      expect(GradientString.matchString('-webkit-linear-gradient(50deg, #2F2727, #1a82f7)')).to.be.equal(true);
      expect(GradientString.matchString('-moz-linear-gradient(left, rgba(248,80,50,0.8) 1%, rgba(241,111,92,0.8) 50%, rgba(240,47,23,0.8) 71%, rgba(231,56,39,0.8) 99%)')).to.be.equal(true);
      expect(GradientString.matchString('yellow')).to.be.equal(false);
      expect(GradientString.matchString('#2F2727')).to.be.equal(false);
      expect(GradientString.matchString('rgba(248,80,50,0.8)')).to.be.equal(false);
      expect(GradientString.matchString('linear-gradient(50deg)')).to.be.equal(false);
      expect(GradientString.matchString('linear-gradient(to top)')).to.be.equal(false);
      expect(GradientString.matchString('linear-gradient(50deg, #2F2727)')).to.be.equal(false);
    });
  });

  describe('parseString()', () => {
    it('should parse gradient string', () => {
      expect(GradientString.parseString('-webkit-linear-gradient(left, #d4e4ef 0%, #86aecc 100%)')).to.be.eql({
        prefix: '-webkit-',
        type: 'linear',
        value: {
          angle: 'left',
      ...
      expect(GradientString.parseString('-moz-linear-gradient(left, #d4e4ef, #86aecc)')).to.be.eql({
        prefix: '-moz-',
        type: 'linear',
        value: {
          angle: 'left',
      ...
      expect(GradientString.parseString('linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 47%, rgba(237,237,237,1) 100%)')).to.be.eql({
        prefix: null,
        type: 'linear',
        value: {
          angle: 'to right',
  ...
  describe('parseParameters()', () => {
    it('should parse parameters', () => {
      expect(GradientString.parseParameters('left, #d4e4ef 0%, #86aecc 100%')).to.be.eql({
        angle: 'left',
        stops: [{
          color: '#d4e4ef',
          position: 0
  ...
  describe('parseStops()', () => {
    it('should parse stops', () => {
      expect(GradientString.parseStops('#d4e4ef 0%, rgb(255, 90, 0) 10%')).to.deep.equal([{
        color: '#d4e4ef',
        position: 0
      }, {
        color: 'rgb(255, 90, 0)',
      ...
      expect(GradientString.parseStops('#d4e4ef, rgb(255, 90, 0)')).to.deep.equal([{
        color: '#d4e4ef',
        position: null
      }, {
        color: 'rgb(255, 90, 0)',
  ...
  describe('formatStops()', () => {
    it('should format stops', () => {
      expect(GradientString.formatStops([{
        color: 'white',
        position: 0,
      }])).to.be.equal('white 0%');
      ...
      expect(GradientString.formatStops([{
        ...
        color: 'rgb(255, 90, 0)',
        position: 1
      }])).to.be.equal('rgb(0, 0, 0) 0%, rgba(100, 100, 100) 50%, rgb(255, 90, 0) 100%');
    ...
    it('should clean clean position', () => {
      expect(GradientString.formatStops([{
        ...
        color: 'rgb(255, 90, 0)',
        position: 1
      }], true)).to.be.equal('rgb(0, 0, 0), rgb(255, 90, 0)');
      ...
      expect(GradientString.formatStops([{
        ...
        color: 'rgb(255, 90, 0)',
        position: 1
      }], true)).to.be.equal('rgb(0, 0, 0), rgba(100, 100, 100) 50%, rgb(255, 90, 0)');
  ...
  describe('parseStop()', () => {
    it('should parse stop', () => {
      ...
      expect(GradientString.parseStop('rgba(100, 100, 100, 20%) 10%')).to.be.eql({
